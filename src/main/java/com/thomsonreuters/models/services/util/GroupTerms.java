...
public class GroupTerms implements Property {
	...
	public void groupTermsBasedOnDictionary(List<String> alldictionaryInfo,
			Map<String, DictionaryInfo> allProperty) {
	...
	public DictionaryInfo getAllDictionaryRelatedInfos(
			Hashtable<String, DictionaryInfo> allProperty, String property) {
